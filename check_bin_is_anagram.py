...
def check_bin_is_anagram(num1, num2):
    ...
    if Counter(n1) == Counter(n2):  # Counter converts string to dictionary format
        return True
    else:
        return False
...
print('Binary representation of two numbers ar an anagram : ', check_bin_is_anagram(num1, num2))


#o/p-  12 9
#  Binary representation of two numbers ar an anagram :  True